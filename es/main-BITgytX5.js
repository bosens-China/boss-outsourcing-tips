    ...
    const e = T(!1), s = [
      {
        tab: "过滤关键词",
        name: "keyword",
        components: N(() => import("./keywords-cfjztMvd.js"))
      },
      {
        tab: "黑名单（公司）",
        name: "blacklist",
        components: N(() => import("./blacklist-RIotbfeG.js"))
      },
      {
        tab: "白名单（公司）",
        name: "whiteList",
        components: N(() => import("./white-list-CODtOGm5.js"))
      }
