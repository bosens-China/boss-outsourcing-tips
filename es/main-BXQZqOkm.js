    ...
    const e = T(!1), s = [
      {
        tab: "过滤关键词",
        name: "keyword",
        components: N(() => import("./keywords-COf7u0Jx.js"))
      },
      {
        tab: "黑名单（公司）",
        name: "blacklist",
        components: N(() => import("./blacklist-B7vQgdlk.js"))
      },
      {
        tab: "白名单（公司）",
        name: "whiteList",
        components: N(() => import("./white-list-r0YHrs51.js"))
      }
